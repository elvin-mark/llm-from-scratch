...
def test_nano_llm_parameter_savings():
    ...
    vocab_size = 4000
    dim = 128
    nano_model = NanoLLM(vocab_size=vocab_size, dim=dim, n_layers=4, n_heads=4, ffn_dim=512)
    tiny_model = TinyLLM(vocab_size=vocab_size, dim=dim, n_layers=4, n_heads=4, ffn_dim=512)
