...
def export_to_onnx(model_path="tiny_llm.pth", tokenizer_path="tokenizer.json", output_path="tiny_llm.onnx", quantize=False):
    ...
    if quantize:
        try:
            ...
            # Dynamic quantization is the safest, most robust option for Transformer models
            quantize_dynamic(
                output_path,
                quantized_path,
            ...
            print("Run `pip install onnx onnxruntime` and run this script again with --quantize to create an Int8 version for the web.")
