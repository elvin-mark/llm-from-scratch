...
if __name__ == "__main__":
    ...
    parser.add_argument("--corpus-file", type=str, default="data/corpus.txt", help="Path to output corpus text file")
    parser.add_argument("--tokenizer-out", type=str, default="checkpoints/tokenizer.json", help="Path to output tokenizer.json file")
